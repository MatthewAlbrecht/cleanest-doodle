  ...
  return (
    <div>
      ...
      <main className="mt-12 container mx-auto">
        ...
        <div className="mt-20">
          <h2 className="text-5xl text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-doodles-green via-doodles-orange to-doodles-pink">
            Leaderboards
          </h2>
          <ul className="mt-8 mx-auto max-w-md divide-y-2 divide-white/25">
    ...
    <div>
      <label htmlFor={inputId}>
        ...
        <input
          ...
          value={dood.id}
        />
        <div className="bg-white hover:bg-white/95 p-4 rounded-lg peer-checked:p-2 peer-checked:border-8 peer-checked:border-doodles-green">
