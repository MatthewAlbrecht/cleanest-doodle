    ...
    <div>
      ...
      <main className="min-h-screen container mx-auto flex justify-center items-center flex-col">
        <h2 className="text-3xl md:text-5xl text-white text-center">
          Which dood is{' '}
          <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-doodles-green via-doodles-orange to-doodles-pink inline-block py-1 md:py-2 border-b-4">
            cleaner
          </span>{' '}
          ?
        </h2>
      ...
      <footer className="fixed bottom-0 left-0 w-full flex justify-between py-4 px-6 sm:px-12">
        <h2>
          <span className="text-black/60">@doodles </span>
          <a
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 496 512"
              className="fill-black/75 h-4 w-4 inline-block"
            >
        ...
        <h2>
          ...
          <a href="https://twitter.com/thisishaam" className="hover:underline">
            haam.eth{' '}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
